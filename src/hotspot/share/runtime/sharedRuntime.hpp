...
class AdapterHandlerEntry : public MetaspaceObj {
 ...
 public:
  ...
  address get_i2c_entry()                  const { return _adapter_blob->i2c_entry(); }
  address get_c2i_entry()                  const { return _adapter_blob->c2i_entry(); }
  address get_c2i_unverified_entry()       const { return _adapter_blob->c2i_unverified_entry(); }
  address get_c2i_no_clinit_check_entry()  const { return _adapter_blob->c2i_no_clinit_check_entry(); }
